      ...
      <footer className="w-full px-8 py-6" style={{
        ...
        <div className="max-w-6xl mx-auto flex pt-8 flex-wrap justify-between items-start gap-8">
          ...
          <div className="flex flex-col gap-4 max-w-sm">
            <h2 className="text-purple-500 text-2xl font-bold">HELLOWORLD</h2>
            <p className="text-gray-300">
              GET AI based predictive model and automate your investment with smart contract execution
            </p>
          </div>
